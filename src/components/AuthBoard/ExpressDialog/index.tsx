...
export const ExpressDialog = memo(
  (props: {
    ...
    const selectedServieId = useSelectedServiceId();
    const [open, setOpen] = useState(false);
    const [exp, setExp] = useState(expression);
    const [error, setError] = useState("");
    const entites = useRecoilValue(classesState(selectedServieId));
    const relations = useRecoilValue(relationsState(selectedServieId));
